...
quieterBtn.addEventListener("click", decreaseVolume);
louderBtn.addEventListener("click", increaseVolume);
...
document.addEventListener("keydown", (event) => {
  ...
  switch (event.key) {
    ...
    case "l":
    case "L":
      toggleLoop(); // Löst dieselbe Funktion aus wie Mausklick auf Loop-Button
      break;
